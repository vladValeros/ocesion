...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="logsDropdown">
                        <li><a class="dropdown-item" href="../admin/logs_events.php">Event Logs</a></li>
                        <li><a class="dropdown-item" href="../admin/logs_students.php">Student Logs</a></li>
                        <li><a class="dropdown-item" href="../admin/logs_attendance.php">Attendance Logs</a></li>
                    </ul>
                </li>
            ...
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" id="userProfileDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="color: #388e3c;">
