...
<?php include 'modals_officer/edit_attendance_modal.php'; ?>
                ...
                <?php foreach ($attendance_data as $entry): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="attendance_officer.php?delete_id=<?= $entry['id'] ?>&event_id=<?= $event_id ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
