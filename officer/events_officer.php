...
<?php include 'modals_officer/edit_event_modal.php'; ?>
<?php include 'modals_officer/add_event_modal.php'; ?>
            ...
            <?php foreach ($events as $event): ?>
                <tr>
                    ...
                    Edit
                        ...
                        <a href="events_officer.php?delete_id=<?= $event['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
